...
<head>
  <title>Manage News - CodeBetter</title>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Manage News</a>
      ...
      <div class="content">
		...
		if (isset($_POST['addBtn']))
		{
			...
			if (empty($errors))
			{
				...
				echo '<div class="Sucess"><p><strong>SUCCESS: </strong>News has been posted!</p></div><br>';
			}
			else
			{
        ...
        <form action="" class="form" method="POST">
            <fieldset>
                <div class="widget">
                    <div class="title"><h5>Post News:</h5></div>
                    <div class="formRow">
                        <label>Title</label>
                    ...
                    <div class="formRow">
                        <label>Detail</label>
                        <div class="formRight"><textarea style="resize:none;width:500px;" rows="4" cols="" name="detailAdd" class="autoGrow"></textarea></div>
                        <div class="clear"></div>
                    </div>
					<div class="formRow">
                        <br>
		...
		if (isset($_POST['deleteBtn']))
		{
			...
			echo '<div class="Sucess"><p><strong>SUCCESS: </strong>New(s) Has Been Removed</p></div><br>';
		}
		?>
		<form action="" class = "form" method="POST">
		<div class="widget">
