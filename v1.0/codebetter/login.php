  ...
  <div id="root" tabindex="-1">
    ...
    <div class="app">
      <header class="app-header inverse" role="banner">
        <a href="https://app.CodeBetter.com/teams/senpaiyellow/settings/general#main" class="skip-to-main">Skip to main content</a>
        <div class="container">
          <div class="navbar">
            <ol class="nav Nav--breadcrumb" aria-label="Breadcrumb">
              <li>
                <a class="logo" title="Home" href="https://app.CodeBetter.com/">
            ...
            <ul class="nav">
              <li>
                <a class="active" href="https://app.CodeBetter.com/login?next=/teams/senpaiyellow/settings/general">Log in</a></li>
              <li><a class="active action-link" href="https://app.CodeBetter.com/signup?next=/teams/senpaiyellow/settings/general">Sign up</a></li>
            </ul>
          </div>
	...
	if (isset($_POST['loginBtn']))
	{
        ...
        $userInfo = $SQLGetInfo -> fetch(PDO::FETCH_ASSOC);
          ...
          $_SESSION['ID'] = $userInfo['ID'];
					echo '<div class="sucess"><p><strong>SUCCESS: </strong>Login Successful.  Redirecting....</p></div><meta http-equiv="refresh" content="3;url=projects.php">';
        }		
        else		
    		{
          echo '<div class="banned"><p><strong>ERROR: </strong>You are banned from our platform please contact an admin for more information</p></div>';
				}
			}
			else
			{
				echo '<div class="failure"><p><strong>ERROR: </strong>Login Failed</p></div>';
			}
		}
		else
		{
...
?>
                  ...
                  <div class="btn-stack">
                    ...
                    <button type="submit" class="btn btn btn-provider btn-email" name="loginBtn" id="loginBtn" style="background-color:#1A2B33">
                    <i class="fa fa-email"></i> Sign In</button>
                    </form>

                    <a href="oauth2/github-login.php" style="width:300px;">
                    <button type="button" class="btn btn btn-provider btn-github" name="github"><i class="fa fa-github"></i> GitHub</button></a>
                  </div>
                </div>
                <p><a class="subdued-link" href="register.php">Sign Up</a></p>
